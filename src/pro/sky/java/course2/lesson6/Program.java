package pro.sky.java.course2.lesson6;

import pro.sky.java.course2.lesson6.driver.DriverB;
import pro.sky.java.course2.lesson6.driver.DriverC;
import pro.sky.java.course2.lesson6.driver.DriverD;
import pro.sky.java.course2.lesson6.transport.*;
    ...
    public static void checkTransportDiagnostics(Transport transport) {
        try {
            if (!transport.passDiagnostics()) {
                throw new RuntimeException("Траспортное средство " + transport.getBrand() + " " + transport.getModel() + " не прошло диагностику");
            }
