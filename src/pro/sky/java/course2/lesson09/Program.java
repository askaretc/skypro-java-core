package pro.sky.java.course2.lesson09;

import pro.sky.java.course2.lesson09.driver.Driver;
import pro.sky.java.course2.lesson09.driver.DriverB;
import pro.sky.java.course2.lesson09.driver.DriverC;
import pro.sky.java.course2.lesson09.driver.DriverD;
import pro.sky.java.course2.lesson09.mechanic.Mechanic;
import pro.sky.java.course2.lesson09.transport.Transport;
import pro.sky.java.course2.lesson09.transport.bus.Bus;
import pro.sky.java.course2.lesson09.transport.car.Car;
import pro.sky.java.course2.lesson09.transport.truck.Truck;
...
public class Program {
    public static void main(String[] args) {
        ...
        mechanicSet.add(mechanic4);
        mechanicSet.add(mechanic5);
        mechanicSet.add(mechanic6);
        mechanicSet.add(mechanic7);
        mechanicSet.add(mechanic8);
        mechanicSet.add(mechanic8);
